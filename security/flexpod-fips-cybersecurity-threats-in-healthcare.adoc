...
image:flexpod-fips-image2.png["Um diagrama que mostra a integração de aplicativos empresariais conectando sistemas clínicos e administrativos hospitalares"]
