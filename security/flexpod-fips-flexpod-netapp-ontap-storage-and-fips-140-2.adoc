...
image:flexpod-fips-image3.png["Um diagrama que mostra o fluxo de dados criptografados de escrita e descriptografados de leitura através de rede, WAFL, RAID e storage com um módulo criptográfico"]
...
image:flexpod-fips-image4.png["Um diagrama que mostra a criptografia e a descriptografia através das camadas de Rede, WAFL, RAID e dos módulos criptográficos de storage"]
...
image:flexpod-fips-image5.png["Um diagrama que mostra o limite criptográfico do ONTAP com os componentes do gerenciador de chaves, cryptomod e cryptomod_fips"]
