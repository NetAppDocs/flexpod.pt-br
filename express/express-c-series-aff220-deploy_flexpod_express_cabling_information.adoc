...
image:express-c-series-aff220-deploy_image5.png["Um diagrama que mostra os switches Cisco Nexus, os servidores Cisco UCS e os controladores NetApp AFF A220 com portas 10GbE destacadas"]
