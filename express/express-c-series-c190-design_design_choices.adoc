...
image:express-c-series-c190-design_image4.png["Um diagrama que mostra as vistas traseiras de dois AFF C190 com portas UTA 2 para módulos SFP+."]

A figura a seguir ilustra portas 10GBASEBASE-T para conexão por meio de cabos Ethernet RJ-45 convencionais.

image:express-c-series-c190-design_image5.png["Um diagrama que mostra o painel traseiro de um AFF C190 com portas RJ-45 10GBASE-T"]
...
Para obter informações completas sobre o sistema de hardware AFF C190, consulte o  https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 documentação"^].
...
image:express-c-series-c190-design_image6.png["Um diagrama que mostra múltiplos blocos lógicos de 4 KB compactados em um único bloco físico de 4 KB"]
...
image:express-c-series-c190-design_image7.png["Vista frontal de um switch Cisco Nexus 31108PC-V com 48 portas SFP+ e seis portas QSFP28"]
...
image:express-c-series-c190-design_image8.png["Vista frontal de um servidor em rack Cisco UCS C220 M5 com duas baias para unidades de disco e a marca Cisco"]
...
image:express-c-series-c190-design_image9.png["Uma captura de tela do adaptador Cisco UCS VIC 1457 com quatro portas SFP28 e um ventilador de resfriamento"]
...
image:express-c-series-c190-design_image10.png["Um diagrama que mostra quatro vNICs conectadas ao FlexPod e aos vSwitches de boot iSCSI em um host VMware ESXi 6.7 U2"]
