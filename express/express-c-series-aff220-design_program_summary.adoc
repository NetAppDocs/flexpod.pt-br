...
image:express-c-series-aff220-design_image2.png["Um diagrama que mostra o FlexPod Express, Datacenter e Select com as implantações e componentes de destino"]
