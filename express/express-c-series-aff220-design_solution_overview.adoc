...
image:express-c-series-aff220-design_image3.png["Um diagrama que mostra as famílias de hardware FlexPod Express para armazenamento, comutação e computação, com opções de configuração"]
...
image:express-c-series-aff220-design_image4.png["Um diagrama que mostra os switches Cisco Nexus 3172P, os servidores UCS C220 M5 e a conectividade de storage AFF A220"]
