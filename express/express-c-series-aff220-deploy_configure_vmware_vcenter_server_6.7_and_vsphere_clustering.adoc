...
. Clique em OK.
+
image:express-c-series-aff220-deploy_image49.png["Uma captura de tela da caixa de diálogo Novo Cluster com DRS e vSphere HA habilitados para o cluster Tiger3"]
...
+
image:express-c-series-aff220-deploy_image50.png["Uma captura de tela do vSphere Web Client mostrando o FlexPod cluster no menu Ações com a opção Adicionar Host selecionada"]
