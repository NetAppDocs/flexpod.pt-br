...
image:express-c-series-c190-deploy_image3.png["Um diagrama que mostra as vistas traseiras de dois switches Nexus, dois servidores Cisco UCS e os controladores AFF C190"]
