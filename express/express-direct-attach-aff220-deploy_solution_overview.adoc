...
image:express-direct-attach-aff220-deploy_image2.png["Um diagrama que compara as soluções FlexPod Express, FlexPod Datacenter e FlexPod Select"]
...
image:express-direct-attach-aff220-deploy_image3.png["Um diagrama que mostra os servidores FlexPod Express, switches Nexus e o cabeamento de armazenamento AFF para gerenciamento, dados, IP, interconexão de cluster e redes vPC peer"]
