...
. Clique em OK.
+
image:express-c-series-c190-deploy_image45.png["Uma captura de tela da caixa de diálogo Novo Cluster com DRS e vSphere HA ativados e vSAN desativado"]
...
+
image:express-c-series-c190-deploy_image46.png["Uma captura de tela do assistente Adicionar hosts do vSphere Client com um campo de entrada para o FQDN do host e o botão Next"]
...
. Faça login em  `https://<vCenter IP>:5480`, digite root como nome de usuário e digite a senha root.
...
+
image:express-c-series-c190-deploy_image47.png["Uma captura de tela dos Appliance Management Services com o VMware vSphere ESXi Dump Collector selecionado e a opção Iniciar disponível"]
...
+
image:express-c-series-c190-deploy_image48.png["Um terminal mostrando comandos de configuração de coredump do ESXi e verificação do servidor netdump"]
