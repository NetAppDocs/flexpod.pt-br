...
image:express-c-series-c190-design_image1.png["Um diagrama que compara as implementações departamentais do FlexPod Express com as cargas de trabalho de missão crítica do FlexPod Datacenter"]
...
image:express-c-series-c190-design_image2.png["Um diagrama que mostra as opções de hardware de armazenamento, switch e servidor do FlexPod Express"]
...
image:express-c-series-c190-design_image3.png["Um diagrama que mostra os switches FlexPod Express, os servidores C220 M5 e as conexões de storage AFF C190"]
