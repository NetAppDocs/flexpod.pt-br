...
+
image:express-c-series-c190-deploy_image4.png["Uma captura de tela do OnCommand System Manager configuração de suporte com AutoSupport e campos de notificação de eventos"]
