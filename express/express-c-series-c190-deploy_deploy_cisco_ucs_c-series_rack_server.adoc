...
+
image:express-c-series-c190-deploy_image5.png["Uma captura de tela que mostra a tela de inicialização de um servidor Cisco solicitando aos usuários que pressionem F8 para a configuração do CIMC"]
...
+
image:express-c-series-c190-deploy_image6.png["Uma captura de tela do Cisco IMC Configuration Utility NIC Properties com NIC dedicada e sem redundância selecionadas"]
...
+
image:express-c-series-c190-deploy_image7.png["Uma captura de tela da página Configure Boot Order do BIOS do Cisco Integrated Management Controller"]
...
+
image:express-c-series-c190-deploy_image8.png["Uma captura de tela da Configuração Avançada da Ordem de Inicialização com KVM-MAPPED-DVD, iSCSI-A e iSCSI-B habilitados"]
...
+
image:express-c-series-c190-deploy_image9.png["Uma captura de tela que mostra as configurações da BIOS CIMC com PCIe Slot 1 e Slot 2 Option ROM desativadas"]
...
+
image:express-c-series-c190-deploy_image10.png["Uma captura de tela da guia Geral do Cisco Integrated Management Controller Adapter Card MLOM, com a opção Port Channel desmarcada"]
...
+
image:express-c-series-c190-deploy_image11.png["Uma captura de tela que mostra as configurações gerais para a vNIC iSCSI eth1 com VLAN 3439 e porta de uplink 1"]



. Selecione o vNIC eth1 à esquerda.
+
image:express-c-series-c190-deploy_image12.png["Uma captura de tela que mostra as configurações do iniciador de propriedades de inicialização iSCSI para a vNIC eth1"]
...
+
image:express-c-series-c190-deploy_image13.png["Uma captura de tela das propriedades de inicialização do iSCSI com detalhes do iniciador, alvo primário e alvo secundário"]
...
+
image:express-c-series-c190-deploy_image14.png["Uma captura de tela que mostra as propriedades de inicialização iSCSI para a vNIC eth3 com as configurações de iniciador e destino"]
...
+
image:express-c-series-c190-deploy_image15.png["Uma captura de tela do Cisco Integrated Management Controller das propriedades da vNIC eth0 com MTU 9000 e VLAN padrão 2"]

. Repita as etapas 3 e 4 para eth1, verificando se a porta uplink está definida como 1 para eth1.
+
image:express-c-series-c190-deploy_image16.png["Uma captura de tela do Cisco Integrated Management Controller listando as vNICs de eth0 a eth3 com MTU, porta uplink e configurações de VLAN"]
