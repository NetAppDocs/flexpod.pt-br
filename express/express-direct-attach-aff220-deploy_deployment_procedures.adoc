...
Siga os procedimentos de instalação física para os controladores no  https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["Documentação do AFF A220"^].
...
| SERVIDOR NTP UM IP | +<< switch-a-ntp-ip >>+ 


| IP DO SERVIDOR NTP B. | +<< switch-b-ntp-ip >>+ 
|===
...
+
image:express-direct-attach-aff220-deploy_image7.png["Uma captura de tela da caixa de diálogo Criar Bloco de Endereços IPv4 com os campos endereço IP, máscara de sub-rede, gateway e DNS"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["Uma captura de tela da caixa de diálogo Adicionar Servidor NTP com o Servidor NTP definido como 10.1.156.4"]

. Clique em Adicionar servidor NTP.
. Introduza `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` e clique em OK. Clique em OK na confirmação.
+
image:express-direct-attach-aff220-deploy_image9.png["Uma captura de tela das configurações de NTP do Cisco UCS Manager com dois servidores NTP listados e o fuso horário America/New_York selecionado"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["Uma captura de tela que mostra as portas Ethernet do Fabric Interconnect A com funções de uplink e armazenamento de appliance configuradas"]
...
. Na guia portas Ethernet, confirme se as portas foram configuradas corretamente na coluna função if. Se algum servidor da série C de porta tiver sido configurado na porta de escalabilidade, clique nele para verificar a conetividade da porta lá.
+
image:express-direct-attach-aff220-deploy_image11.png["Uma captura de tela que mostra as portas Ethernet do Fabric Interconnect B com funções de rede e armazenamento de appliance configuradas"]
...
. Clique em seguinte.
+
image:express-direct-attach-aff220-deploy_image12.png["Uma captura de tela da caixa de diálogo Criar Canal de Porta com ID 1 e nome vPC-13-Nexus inserido"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["Uma captura de tela da caixa de diálogo Criar VLANs com NFS-VLAN e VLAN ID 3170 inseridos"]
...
. Clique em OK e, em seguida, clique em OK novamente para criar a VLAN.
+
image:express-direct-attach-aff220-deploy_image14.png["Uma captura de tela que mostra a tabela de VLANs no Cisco UCS Manager com nomes e IDs de VLANs"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["Uma captura de tela que mostra a política de controle de rede Enable_CDP com CDP e LLDP habilitados para transmissão e recepção"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["Uma captura de tela das propriedades da Appliance Interface 1/3 com CDP ativado e VLANs de armazenamento selecionadas"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["Captura de tela das configurações de VLAN da Appliance Interface 1/3 com iSCSI-B, NFS e VLANs nativas selecionadas"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Uma captura de tela das configurações de classe do sistema QoS do Cisco UCS Manager com Best Effort MTU definido para 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Captura de tela da caixa de diálogo Modificar Versões do Pacote com o Blade Package 4.0(1b)B selecionado"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["Uma captura de tela da caixa de diálogo Criar um Bloco de Endereços MAC com o endereço MAC 00:25:B5:32:0A:00 e tamanho 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["Uma captura de tela da caixa de diálogo Criar um bloco de sufixos IQN com o sufixo ucs-host, de 1 e tamanho 16"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["Uma captura de tela da caixa de diálogo Criar Política de Controle de Rede com CDP e LLDP ativados"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["Uma captura de tela da caixa de diálogo Criar Política de Controle de Energia com No-Power-Cap e No Cap selecionados"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Uma captura de tela do Cisco UCS Manager na caixa de diálogo \"Create CPU/Cores Qualification\", com arquitetura de processador Xeon e campo CPU PID"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["Uma captura de tela da caixa de diálogo Criar Política de BIOS com o nome do host da VM e a Nomenclatura de Dispositivo Consistente ativada"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["Uma captura de tela da guia Criar BIOS Policy Processor com Processor C State e C1E desativados"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Uma captura de tela que mostra as opções do processador na BIOS com Energy Performance e DRAM Clock Throttling definidas como desempenho"]
...
+
image:express-direct-attach-aff220-deploy_image28.png["Uma captura de tela da página Create BIOS Policy RAS Memory com o LV DDR Mode definido como Performance Mode"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["Uma captura de tela da política de manutenção padrão do Cisco UCS Manager com as opções \"Confirmação do usuário\" e \"Na próxima inicialização\" selecionadas"]
...
. Clique em OK.
+
image:express-direct-attach-aff220-deploy_image30.png["Uma captura de tela do Cisco UCS Manager mostrando as propriedades do modelo vNIC para vNIC_Template_A no Fabric A"]
...
. Clique em OK.
+
image:express-direct-attach-aff220-deploy_image31.png["Uma captura de tela das configurações do modelo B da vNIC do Cisco UCS Manager com o Fabric B, MTU 9000 e o MAC Pool B selecionados"]
...
. Clique em OK.
+
image:express-direct-attach-aff220-deploy_image32.png["Uma captura de tela do modelo de vNIC Site_01_iSCSI-A com o Fabric A, MTU 9000 e o MAC Pool A56/64 selecionados"]
...
. Clique em OK.
+
image:express-direct-attach-aff220-deploy_image33.png["Uma captura de tela do Cisco UCS Manager das configurações do modelo vNIC Site_01_iSCSI-B para o Fabric B com MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["Uma captura de tela que mostra a caixa de diálogo Modificar vNIC para Site-01-vNIC-A usando vNIC_Template_A e a política do adaptador VMWare"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Uma captura de tela da caixa de diálogo \"Modificar vNIC iSCSI\" para Site-01-iSCSI-A com configurações de VLAN e endereço MAC"]
...
. Clique em Salvar alterações.
+
image:express-direct-attach-aff220-deploy_image36.png["Uma captura de tela da política de conectividade LAN Site-01-iSCSIBoot com duas vNICs iSCSI listadas"]
...
+
Esta ISO do VMware ESXi 6.7U1 pode ser baixada de https://support.broadcom.com/group/ecx/downloads["Portal de suporte Broadcom"^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["Uma captura de tela da caixa de diálogo Criar vMedia Mount configurada com um arquivo ISO remoto do instalador HTTP do ESXi e caminho"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["Uma captura de tela da política de inicialização do Cisco UCS Manager Site-01-Fabric-A com duas entradas de inicialização iSCSI configuradas"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["Uma captura de tela do assistente Criar Modelo de Perfil de Serviço com os campos nome, atualização do modelo e pool de UUID"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["Uma captura de tela das configurações de rede do modelo de perfil de serviço criado, com conectividade iSCSI-Boot e IQN_Pool selecionados"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Uma captura de tela da página \"Create Service Profile Template Server Boot Order\" com Boot-Fabric-A selecionado"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Uma captura de tela da saída do comando `iscsi show` listando um alvo Infra-SVM, o IQN, o alias e o status de atividade."]

. Introduza o endereço IP de `iscsi_lif_02a` para o campo Endereço IPv4.
+
image:express-direct-attach-aff220-deploy_image43.png["Uma captura de tela da caixa de diálogo Criar Alvo Estático iSCSI com o endereço IPv4 192.168.10.62 inserido"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["Uma captura de tela da caixa de diálogo Criar Alvo Estático iSCSI com o endereço IPv4 192.168.10.61 e ID de LUN 0"]

. Clique em OK para adicionar o destino estático iSCSI.
+
image:express-direct-attach-aff220-deploy_image45.png["Uma captura de tela da caixa de diálogo \"Definir parâmetros de inicialização iSCSI\" com interfaces de destino estáticas iSCSI selecionadas"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["Uma captura de tela da caixa de diálogo Criar destino estático iSCSI com o endereço IPv4 definido como 192.168.20.62"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["Uma captura de tela da caixa de diálogo Criar Alvo Estático iSCSI com o endereço IPv4 192.168.20.61 e o ID LUN 0"]

. Clique em OK para adicionar o destino estático iSCSI.
+
image:express-direct-attach-aff220-deploy_image48.png["Uma captura de tela que mostra duas interfaces de destino iSCSI estáticas selecionadas em Definir parâmetros de inicialização iSCSI"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["Uma captura de tela da etapa Criar Política de Manutenção do Modelo de Perfil de Serviço com a política padrão selecionada"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Captura de tela da atribuição de servidor do modelo de perfil de serviço \"Create Service Profile Template\" com Infra-Pool, estado de energia desligado e pacote de firmware padrão selecionados"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["Uma captura de tela da página \"Create Service Profile Template Operational Policies\" com \"VM-Host BIOS\" e \"No-Power-Cap\" selecionados"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["Uma captura de tela da caixa de diálogo Criar Perfis de Serviço a partir de Modelo com o prefixo Site-01-Infra-0, número 2 e organização raiz"]
...
. Faça login no site de download do portal de suporte da Broadcom: https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Você precisará de um ID de usuário e senha da Broadcom. Procure por VMware vSphere Hypervisor (ESXi) ISOs personalizadas.
. Baixe a imagem personalizada da Cisco para o CD de instalação do ESXi 6.7U1.
...
. Prima Enter.
+
image:express-direct-attach-aff220-deploy_image53.png["Uma captura de tela da tela de Adaptadores de Rede do ESXi com vmnic0 e vmnic1 selecionados e conectados"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["Uma captura de tela que mostra os detalhes do vSwitch0 e a topologia com adaptadores VMkernel e dois adaptadores físicos"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["Uma captura de tela da guia NICs do VMkernel do ESXi listando cinco adaptadores VMkernel e seus grupos de portas"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["Uma captura de tela da guia Adaptadores de armazenamento do ESXi com o adaptador de software iSCSI vmhba64 selecionado"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["Uma captura de tela da caixa de diálogo Configurar iSCSI mostrando quatro destinos iSCSI dinâmicos e estáticos na porta 3260"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["Uma captura de tela do assistente Novo armazenamento de dados com a opção Montar armazenamento de dados NFS selecionada como tipo de criação"]
...
.. Clique em seguinte.
+
image:express-direct-attach-aff220-deploy_image59.png["Uma captura de tela da página Fornecer detalhes de montagem NFS com infra_datastore_1 e servidor NFS 192.168.104.3"]
...
. Clique em concluir. O datastore agora deve aparecer na lista de datastore.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["Uma captura de tela da lista de datastores do ESXi Storage mostrando o infra_datastore_2 montado como um datastore NFS"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["Uma captura de tela da caixa de diálogo Editar configuração de hora com o NTP ativado e dois endereços de servidor NTP inseridos"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["Uma captura de tela da página Gerenciar Swap do Sistema do VMware ESXi mostrando as configurações de swap e Editar configurações"]

. Clique em Edit Settings (Editar definições). Selecione `infra_swap` a partir das opções do datastore.
+
image:express-direct-attach-aff220-deploy_image63.png["Uma captura de tela da caixa de diálogo Editar configuração de swap com o datastore infra_swap selecionado e os botões Salvar e Cancelar"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Uma captura de tela do navegador de hosts ESXi com o botão Obter vCenter Server destacado"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Uma captura de tela da página Select deployment type do Appliance Installer do vCenter Server, com Embedded Platform Services Controller selecionado"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["Uma captura de tela da página de destino de implantação do appliance do instalador do vCenter Server com as credenciais do host ESXi inseridas"]
...
+
image:express-direct-attach-aff220-deploy_image67.png["Uma captura de tela da página Set up appliance VM do vCenter Server Appliance Installer, com os campos de nome da VM e senha de root"]

. Selecione o tamanho de implantação que melhor se adapta ao seu ambiente. Clique em seguinte.
+
image:express-direct-attach-aff220-deploy_image68.png["Uma captura de tela da página Select deployment size do vCenter Server Appliance Installer com a opção Tiny selecionada"]

. Selecione o `infra_datastore_1` datastore. Clique em seguinte.
+
image:express-direct-attach-aff220-deploy_image69.png["Uma captura de tela da página Selecionar armazenamento de dados do instalador do vCenter Server Appliance, com o datastore infra_datastore_1 listado entre três datastores"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["Uma captura de tela da página \"Configure network settings\" do instalador do vCenter Server Appliance, com detalhes de IPv4 estático"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["Uma captura de tela que mostra a implantação bem-sucedida do servidor vCenter na Etapa 1 com um botão Continuar"]
...
. Clique em OK.
+
image:express-direct-attach-aff220-deploy_image72.png["Uma captura de tela da caixa de diálogo Novo Cluster com DRS e vSphere HA ativados para o cluster Express"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["Uma captura de tela do menu Ações do vSphere Client para o cluster Express com a opção Adicionar Hosts selecionada"]
