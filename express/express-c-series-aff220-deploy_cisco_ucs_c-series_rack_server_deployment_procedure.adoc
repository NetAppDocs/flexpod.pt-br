...
+
image:express-c-series-aff220-deploy_image8.png["Uma captura de tela da tela de inicialização de um servidor Cisco solicitando que você pressione F8 para configurar o CIMC"]
...
*** Nenhum: [X]
+
image:express-c-series-aff220-deploy_image9.png["Uma captura de tela das propriedades da NIC do Cisco IMC com configurações IPv4 e sem redundância de NIC selecionada"]
...
+
image:express-c-series-aff220-deploy_image10.png["Uma captura de tela do utilitário de configuração do Cisco IMC mostrando propriedades comuns e configurações de porta"]
...
+
image:express-c-series-aff220-deploy_image11.png["Uma captura de tela das configurações da BIOS do Cisco Integrated Management Controller com \"Configurar ordem de inicialização\" selecionado"]
...
+
image:express-c-series-aff220-deploy_image12.png["Uma captura de tela da Configuração Avançada da Ordem de Inicialização com KVM-MAPPED-DVD, iSCSI-A e iSCSI-B habilitados"]
...
+
image:express-c-series-aff220-deploy_image13.png["Uma captura de tela que mostra as configurações da BIOS CIMC com PCIe Slot 1 e Slot 2 Option ROM desativadas"]
...
+
image:express-c-series-aff220-deploy_image14.png["Uma captura de tela que mostra as configurações do iSCSI-vNIC-A com MTU 9000, VLAN 3439, modo de tronco e inicialização PXE habilitada"]
...
+
image:express-c-series-aff220-deploy_image15.png["Uma captura de tela que mostra a iSCSI-vNIC-A selecionada com as Propriedades de Inicialização iSCSI expandidas na guia vNICs"]
...
+
image:express-c-series-aff220-deploy_image16.png["Uma captura de tela das propriedades de inicialização iSCSI do Cisco UCS mostrando os campos nome do iniciador, endereço IP, máscara de sub-rede e gateway"]
...
+
image:express-c-series-aff220-deploy_image17.png["Uma captura de tela que mostra as configurações do iniciador vNIC iSCSI com os destinos primário e secundário NetApp"]
...
+
image:express-c-series-aff220-deploy_image18.png["Uma captura de tela da aba vNICs do Cisco VIC listando eth0, eth1 e duas vNICs iSCSI"]

. Selecione eth0 e clique em Propriedades.
. Defina a MTU como 9000. Clique em Salvar alterações.
+
image:express-c-series-aff220-deploy_image19.png["Uma captura de tela das propriedades da vNIC eth0 do Cisco VIC com o campo MTU definido como 9000"]

. Repita as etapas 3 e 4 para eth1, verificando se a porta uplink está definida como `1` para eth1.
+
image:express-c-series-aff220-deploy_image20.png["Uma captura de tela que mostra a aba vNICs com eth0 e eth1 com MTU definido como 9000 e as portas de uplink 0 e 1"]
