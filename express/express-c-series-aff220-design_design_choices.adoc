...
Para obter mais informações sobre o AFF A220, consulte o  https://www.netapp.com/aff-a-series/["Página inicial do AFF Série A."^].
...
image:express-c-series-aff220-design_image5.png["Um diagrama que mostra múltiplos blocos lógicos de 4 KB compactados em um único bloco físico de 4 KB"]
...
image:express-c-series-aff220-design_image6.png["Um diagrama que mostra os discos particionados em partições raiz, Controlador 1 e Controlador 2"]

Esses são apenas alguns dos principais recursos que complementam a solução FlexPod Express. Para obter detalhes sobre os recursos e funcionalidades adicionais do ONTAP 9.4, consulte o  https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["Folha de dados do software de gerenciamento de dados ONTAP 9"^]. Consulte também o NetApp http://docs.netapp.com/ontap-9/index.jsp["Centro de Documentação do ONTAP 9"^], que foi atualizado para incluir o ONTAP 9.4.
...
image:express-c-series-aff220-design_image7.png["Uma captura de tela que mostra a vista frontal de um switch Cisco Nexus 3172 com portas de rede"]
...
image:express-c-series-aff220-design_image8.png["Vista frontal de um servidor em rack Cisco UCS C220 M5 com duas baias para unidades de disco e a marca Cisco"]
...
image:express-c-series-aff220-design_image9.png["Uma placa adaptadora Cisco UCS VIC 1387 com duas portas QSFP+ e um ventilador de refrigeração"]
...
image:express-c-series-aff220-design_image10.png["Uma fotografia de um módulo adaptador Cisco CVR-QSFP-SFP10G QSFP-para-SFP"]
