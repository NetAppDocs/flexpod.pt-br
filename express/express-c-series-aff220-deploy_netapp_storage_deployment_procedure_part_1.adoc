...
+
image:express-c-series-aff220-deploy_image6.png["Uma captura de tela do System Manager mostrando os campos de configuração do cluster do Guided Setup para dois nós de par de HA e licenças"]
...
+
image:express-c-series-aff220-deploy_image7.png["Uma captura de tela do OnCommand System Manager configuração de suporte com AutoSupport e campos de notificação de eventos"]
