...
+
image:express-c-series-c190-deploy_image34.png["Uma captura de tela da página do Contrato de Licença de Usuário Final do Instalador do vCenter Server Appliance com aceitação selecionada"]

. Selecione controlador de serviços de plataforma incorporada como o tipo de implantação.
+
image:express-c-series-c190-deploy_image35.png["Uma captura de tela da página de tipo de implantação do vCenter Server Appliance Installer com o Embedded Platform Services Controller selecionado"]
...
+
image:express-c-series-c190-deploy_image36.png["Uma captura de tela do vCenter Server Appliance Installer, formulário de destino de implantação do appliance com as credenciais do host ESXi"]

. Defina a VM do appliance inserindo o VCSA como o nome da VM e a senha raiz que você gostaria de usar para o VCSA.
+
image:express-c-series-c190-deploy_image37.png["Uma captura de tela da página Set up appliance VM do vCenter Server Appliance Installer, com os campos de nome da VM e senha de root"]

. Selecione o tamanho de implantação que melhor se adapta ao seu ambiente. Clique em seguinte.
+
image:express-c-series-c190-deploy_image38.png["Uma captura de tela da página Select deployment size do vCenter Server Appliance Installer com a opção Tiny selecionada"]
...
+
image:express-c-series-c190-deploy_image39.png["Uma captura de tela da página Configure network settings do Appliance Installer do vCenter Server, com MGMT-Network selecionado"]

. Reveja as suas definições na fase 1 antes de iniciar a implementação do dispositivo.
+
image:express-c-series-c190-deploy_image40.png["Uma captura de tela da página de revisão das configurações da etapa 1 do instalador do vCenter Server Appliance pronta para ser concluída"]
...
+
image:express-c-series-c190-deploy_image41.png["Uma captura de tela da página de Introdução da Etapa 2 do Instalador do vCenter Server Appliance com um botão \"Avançar\""]
...
+
image:express-c-series-c190-deploy_image42.png["Uma captura de tela do vCenter Server Appliance Installer Stage 2 configuração SSO com um novo domínio SSO selecionado"]
...
+
image:express-c-series-c190-deploy_image43.png["Uma captura de tela da página Configure CEIP do vCenter Server Appliance Installer com a opção CEIP selecionada"]
...
+
image:express-c-series-c190-deploy_image44.png["Uma captura de tela de um instalador do vCenter Server Appliance avisando que a instalação não pode ser pausada ou interrompida, com os botões Cancelar e OK"]
