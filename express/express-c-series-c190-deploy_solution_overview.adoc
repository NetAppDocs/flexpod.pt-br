...
image:express-c-series-c190-deploy_image1.png["Um diagrama que mostra o FlexPod Express e o FlexPod Datacenter com opções de portfólio e casos de uso"]
...
image:express-c-series-c190-deploy_image2.png["Um diagrama que mostra os switches FlexPod Express, os servidores C220 M5 e as conexões de storage AFF C190"]
