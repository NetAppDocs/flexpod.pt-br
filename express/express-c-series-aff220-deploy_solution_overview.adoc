...
image:express-c-series-aff220-deploy_image3.png["Um diagrama que compara o FlexPod Express, Datacenter e Select, seus objetivos e componentes de infraestrutura"]
...
image:express-c-series-aff220-deploy_image4.png["Um diagrama que mostra os switches Cisco Nexus 3172P, os servidores UCS C220 M5 e a conectividade de storage AFF A220"]
