...
+
image:express-c-series-c190-deploy_image17.png["Uma captura de tela da página da BIOS do servidor Cisco CIMC com o link \"Iniciar KVM\" no menu superior"]
...
=== Baixe a imagem personalizada do Cisco ESXi 6.7U2
...
+
image:express-c-series-c190-deploy_image18.png["Uma captura de tela do instalador do ESXi selecionando um dispositivo de storage NETAPP LUN C-Mode com capacidade de 15,00 GiB"]
...
+
image:express-c-series-c190-deploy_image19.png["Uma captura de tela da tela de Adaptadores de Rede do ESXi com vmnic2 e vmnic4 selecionados para rede de gerenciamento"]
...
+
image:express-c-series-c190-deploy_image20.png["Uma captura de tela da página de rede do ESXi com a guia Switches Virtuais mostrando vSwitch0 e iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["Uma captura de tela das configurações de agregação e failover do iSCSIBootPG-A com a vmnic3 ativa e a vmnic5 não utilizada"]
...
+
image:express-c-series-c190-deploy_image22.png["Uma captura de tela da guia Adaptadores de armazenamento do ESXi com o adaptador de software iSCSI vmhba64 selecionado"]

. Em alvos dinâmicos, clique em Adicionar alvo dinâmico.
+
image:express-c-series-c190-deploy_image23.png["Uma captura de tela que mostra os alvos dinâmicos iSCSI com quatro endereços IP e a porta 3260 configurada"]
...
+
image:express-c-series-c190-deploy_image24.png["Uma captura de tela de quatro endereços de destino dinâmicos iSCSI usando a porta 3260 e o botão Salvar Configuração"]
...
. Selecione vSwitch0.
+
image:express-c-series-c190-deploy_image25.png["Uma captura de tela da página do ESXi vSwitch0 mostrando MTU 9000 e os adaptadores vmnic2 e vmnic4 ativos"]
...
+
image:express-c-series-c190-deploy_image26.png["Uma captura de tela da página de Networking do ESXi com a guia Port groups selecionada e Add port group disponível"]
...
+
image:express-c-series-c190-deploy_image27.png["Uma captura de tela da guia de rede VMkernel NICs do ESXi, listando as interfaces vmk0 e vmk1"]
...
+
image:express-c-series-c190-deploy_image28.png["Uma captura de tela da caixa de diálogo Adicionar NIC VMkernel com configurações IPv4 estáticas e vMotion selecionado"]
...
+
image:express-c-series-c190-deploy_image29.png["Uma captura de tela da página de storage do VMware ESXi com o botão Novo datastore visível"]

. Selecione Monte o armazenamento de dados NFS.
+
image:express-c-series-c190-deploy_image30.png["Uma captura de tela do assistente Novo armazenamento de dados com a opção Montar armazenamento de dados NFS selecionada como tipo de criação"]
...
. Clique em Guardar.
+
image:express-c-series-c190-deploy_image31.png["Uma captura de tela que mostra as configurações de data e hora do ESXi com o serviço NTP em execução e três servidores NTP"]
...
+
image:express-c-series-c190-deploy_image32.png["Uma captura de tela da página Gerenciar Swap do Sistema do VMware ESXi com as configurações de swap exibidas"]

. Clique em Edit Settings (Editar definições). Selecione `infra_swap` a partir das opções do datastore.
+
image:express-c-series-c190-deploy_image33.png["Uma captura de tela da caixa de diálogo Editar configuração de swap com infra_swap selecionado como datastore e os botões Save e Cancel."]
