...
+
image:express-c-series-aff220-deploy_image21.png["Uma captura de tela da página da BIOS do servidor Cisco CIMC com o link \"Iniciar KVM\" no menu superior"]
...
=== Baixe a imagem personalizada do Cisco ESXi 6.7

. Navegue até a  https://support.broadcom.com/group/ecx/downloads["Portal de download do suporte Broadcom"^] seção de ISOs personalizadas.
...
+
image:express-c-series-aff220-deploy_image22.png["Uma captura de tela do instalador do ESXi selecionando um dispositivo de storage NETAPP LUN C-Mode com capacidade de 15,00 GiB"]
...
+
image:express-c-series-aff220-deploy_image23.png["Uma captura de tela do menu Adaptadores de Rede do ESXi com vmnic0 e vmnic1 selecionados para vSwitch0"]
...
+
image:express-c-series-aff220-deploy_image24.png["Uma captura de tela da guia Switches Virtuais de Rede do ESXi mostrando vSwitch0 e iScsiBootvSwitch"]
...
** Clique em criar.
+
image:express-c-series-aff220-deploy_image25.png["Uma captura de tela do formulário Adicionar NIC VMkernel configurando iScsiBootPG-B com configurações IPv4 estáticas e MTU 9000"]
...
+
image:express-c-series-aff220-deploy_image26.png["Uma captura de tela da página de adaptadores de storage do VMware ESXi com o adaptador de software iSCSI vmhba64 selecionado"]

. Em alvos dinâmicos, clique em Adicionar alvo dinâmico.
+
image:express-c-series-aff220-deploy_image27.png["Uma captura de tela da caixa de diálogo Configurar iSCSI com a opção Adicionar destino dinâmico em Destinos dinâmicos"]
...
+
image:express-c-series-aff220-deploy_image28.png["Uma captura de tela que mostra quatro endereços IP de destino dinâmicos iSCSI, cada um usando a porta 3260"]
...
. Selecione vSwitch0.
+
image:express-c-series-aff220-deploy_image29.png["Uma captura de tela da página vSwitch0 do VMware ESXi mostrando MTU 1500 e dois adaptadores físicos ativos"]
...
+
image:express-c-series-aff220-deploy_image30.png["Uma captura de tela da página de Networking do ESXi com a guia Port groups selecionada e Add port group disponível"]
...
+
image:express-c-series-aff220-deploy_image31.png["Uma captura de tela da guia NICs do VMkernel de rede do ESXi, listando os adaptadores vmk0 e vmk1"]
...
** Clique em criar.
+
image:express-c-series-aff220-deploy_image32.png["Uma captura de tela do formulário Adicionar NIC VMkernel configurando o grupo de portas NFS-Network com configurações IPv4 estáticas"]
...
+
image:express-c-series-aff220-deploy_image33.png["Uma captura de tela da caixa de diálogo Adicionar NIC VMkernel com configurações IPv4 estáticas e vMotion selecionado"]
...
+
image:express-c-series-aff220-deploy_image34.png["Uma captura de tela da página de storage do VMware ESXi com o botão Novo datastore visível"]

. Selecione Monte o armazenamento de dados NFS.
+
image:express-c-series-aff220-deploy_image35.png["Uma captura de tela do assistente Novo armazenamento de dados com a opção Montar armazenamento de dados NFS selecionada como tipo de criação"]
...
+
image:express-c-series-aff220-deploy_image36.png["Uma captura de tela da página \"Gerenciar hora e data do sistema\" do ESXi, mostrando o status do cliente NTP e os servidores NTP"]
...
. Clique em Guardar.
+
image:express-c-series-aff220-deploy_image37.png["Uma captura de tela da caixa de diálogo Editar configuração de hora com o NTP ativado e um servidor NTP inserido"]
...
+
image:express-c-series-aff220-deploy_image38.png["Uma captura de tela da página Gerenciar Swap do Sistema do VMware ESXi com as configurações de swap exibidas"]

. Clique em Edit Settings (Editar definições). Selecione infra_swap nas opções do datastore.
+
image:express-c-series-aff220-deploy_image39.png["Uma captura de tela da caixa de diálogo Editar configuração de swap com infra_swap selecionado como datastore e os botões Save e Cancel."]
...
+
image:express-c-series-aff220-deploy_image40.png["Um terminal exibindo a instalação bem-sucedida do plug-in NFS VIB da NetApp e uma mensagem indicando que é necessário reinicializar"]
