...
image:cloud-fabricpool_image4.png["Um diagrama que mostra o tiering somente de snapshots, movendo cópias de snapshots de um cluster primário para storage de nuvem"]
...
image:cloud-fabricpool_image5.png["Um diagrama que mostra o Auto Tiering movendo dados inativos do armazenamento primário do cluster para storage de nuvem"]
