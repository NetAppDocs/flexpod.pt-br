...
image:cloud-fabricpool_image10.png["Um diagrama que mostra configurações válidas e inválidas de vinculação de agregados a buckets do FabricPool"]
...
+
image:cloud-fabricpool_image11.png["Uma captura de tela da pesquisa no console da AWS mostrando o resultado \"Armazenamento escalável S3 na nuvem\" em destaque"]

. Na página inicial do S3, selecione criar balde.
. Insira um nome compatível com DNS e escolha a região para criar o intervalo.
+
image:cloud-fabricpool_image12.png["Uma captura de tela da caixa de diálogo Criar bucket da AWS, com o nome do bucket, a região e o botão Criar"]
