...
Mais informações sobre o licenciamento do Intersight e os recursos suportados em cada licença podem ser encontradas  https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["aqui"^].
...
Após reivindicar o Intersight Assist no Intersight, você pode reivindicar dispositivos de endpoint usando a opção "Reivindicar através do Intersight Assist". Para mais informações, consulte  https://intersight.com/help/saas/getting_started/overview["Como começar"^].
