...
image:cloud-fabricpool_image2.png["Um diagrama que mostra o armazenamento FlexPod, os switches Cisco Nexus e MDS, e as famílias Cisco UCS com orientações de conectividade"]
...
image:cloud-fabricpool_image3.png["Um diagrama que mostra as conexões do Cisco UCS, Nexus 93180YC-EX, AFF A300 e MDS 9148S"]
