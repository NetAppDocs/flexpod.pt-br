...
image:cloud-fabricpool_image8.png["Uma captura de tela da caixa de diálogo Adicionar Pacotes de Licença do OnCommand System Manager, com os botões Escolher Arquivos e Adicionar"]
...
image:cloud-fabricpool_image9.png["Uma captura de tela dos detalhes das licenças do ONTAP System Manager mostrando a capacidade de licença do FabricPool de 10 TB e a capacidade atual de 0 Byte"]
