...
https://github.com/ucs-compute-solutions/cvo_snapmirror["Este link do GitHub"^]Fornece a configuração do Terraform com vários recursos. Você pode criar um fork deste repositório e fazer uma cópia em sua conta GitHub.
