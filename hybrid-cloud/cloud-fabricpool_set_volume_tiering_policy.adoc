...
. Clique em Guardar.
+
image:cloud-fabricpool_image16.png["Uma captura de tela que mostra a caixa de diálogo Alterar Política de Hierarquização de Volume com as opções de política de hierarquização expandidas"]
