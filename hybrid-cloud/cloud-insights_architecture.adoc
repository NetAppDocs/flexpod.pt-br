...
image:cloud-insights_image2.png["Um diagrama que mostra Cisco UCS, switches Nexus, controladoras NetApp AFF A800 e switches MDS interconectados por links de rede"]
...
* Analisando o ambiente com os dados fornecidos ao NetApp Digital Advisor para avaliação dos riscos do sistema de storage e recomendações para otimização do storage.
