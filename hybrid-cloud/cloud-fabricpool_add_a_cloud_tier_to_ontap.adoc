...
image:cloud-fabricpool_image13.png["Uma captura de tela do formulário Adicionar Camada de Nuvem configurado para um provedor de camada de nuvem Amazon S3"]
