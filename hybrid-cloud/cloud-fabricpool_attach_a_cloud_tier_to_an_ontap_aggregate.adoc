...
+
image:cloud-fabricpool_image14.png["Uma captura de tela que mostra o menu de navegação do OnCommand System Manager com Applications  Tiers selecionado"]

. Clique em camadas de armazenamento.
. Clique em um agregado.
. Clique em ações e selecione Anexar nível de nuvem.
+
image:cloud-fabricpool_image15.png["Uma captura de tela que mostra o menu Mais ações com a opção Anexar camada de nuvem selecionada"]
