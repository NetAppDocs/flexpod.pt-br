...
NOTE: Consulte o  https://hwu.netapp.com/DetailViews/Home.aspx[][NetApp Hardware Universe^] para obter as informações mais recentes sobre plataformas compatíveis com FabricPool.

* NetApp ONTAP Select [NOTA] NetApp recomenda o uso de camadas locais FabricPool compostas exclusivamente por SSDs.
* Categorias de nuvem
+
