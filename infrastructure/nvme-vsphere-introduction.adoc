...
Em parceria com: image:cisco logo.png[""]
...
image:nvme-vsphere-image1.png["Um diagrama que mostra o FlexPod, armazenamento, switch e as famílias de componentes Cisco UCS com as séries de produtos suportadas"]
