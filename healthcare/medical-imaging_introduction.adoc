...
A assistência médica, como a conhecemos, gira em torno de profissionais de saúde (médicos, enfermeiros, radiologistas, técnicos de dispositivos médicos e assim por diante) e pacientes. À medida que aproximamos pacientes e profissionais, tornando a localização geográfica apenas um ponto de dado, torna-se ainda mais importante que a plataforma subjacente esteja disponível quando profissionais e pacientes precisarem dela. A plataforma deve ser eficiente e econômica a longo prazo. Em seus esforços para reduzir ainda mais os custos da assistência ao paciente,  https://www.cms.gov/priorities-innovation-key-concepts-accountable-care-accountable-care-organizations["Organizações de cuidados responsáveis"^] (ACOs) seriam fortalecidas por uma plataforma eficiente.
...
* As modalidades móveis, como dispositivos de digitalização portáteis e sem fio (por exemplo, scanners de ultrassom portáteis de bolso conectados a um telefone), exigem uma infraestrutura de rede robusta com segurança, confiabilidade e latência em nível DoD na borda, no núcleo e na nuvem.  https://www.netapp.com/blog/medical-imaging-cloud-disaster-recovery-meets-ai/["Data fabric desenvolvido pela NetApp"^] fornece às organizações essa capacidade em escala.
* As modalidades mais recentes têm necessidades de armazenamento exponenciais; por exemplo, a TC e a RM requerem algumas centenas de MB para cada modalidade, mas as imagens de patologia digital (incluindo imagens de lâminas inteiras) podem ter alguns GB de tamanho. FlexPod é projetado com  https://www.netapp.com/pdf.html?item=/media/16926-sb-flexpod-advantage-performance-agility-economics.pdf["desempenho, confiabilidade e dimensionamento como caraterísticas fundamentais"^].
...
image:medical-imaging_image2.png["Um diagrama que mostra o modelo de suporte cooperativo do FlexPod entre clientes, Cisco e NetApp"]
