...
image:flexpod-genomics-image6.png["Um diagrama que mostra o FlexPod para Genomics com Cisco UCS, Nexus, MDS e NetApp AFF A700 conectados"]

O diagrama a seguir mostra os detalhes do cabeamento do FlexPod.

image:flexpod-genomics-image7.png["Um diagrama que mostra o FlexPod para Genomics com a fiação entre UCS, Nexus, NetApp AFF e os switches MDS"]
