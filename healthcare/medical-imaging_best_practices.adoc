...
image:medical-imaging_image8.png["Um diagrama que mostra os nós AFF A300 com ifgrps a0a, VLANs e LIFs NFS e iSCSI"]
...
* Use a tecnologia de replicação baseada em array de storage da NetApp chamada  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] em vez da replicação baseada em vSphere.
