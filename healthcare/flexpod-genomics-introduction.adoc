...
image:flexpod-genomics-image2.png["Um diagrama que mostra aplicações hospitalares unificadas no FlexPod com protocolos, armazenamento e conectividade em nuvem"]
