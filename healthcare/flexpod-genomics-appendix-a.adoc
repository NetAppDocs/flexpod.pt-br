...
summary: Esta seção fornece a saída do arquivo jar do GATK. 
---
...
link:flexpod-genomics-genomics---gatk-setup-and-execution.html["Anterior: Genômica - configuração e execução do GATK."]
