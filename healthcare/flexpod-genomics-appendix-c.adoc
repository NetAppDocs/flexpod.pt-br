...
summary: Esta seção mostra a saída depois de executar o GATK usando o motor Cromwell. 
---
...
....
link:flexpod-genomics-appendix-d-gpu-setup.html["Próximo: Configuração da GPU."]
