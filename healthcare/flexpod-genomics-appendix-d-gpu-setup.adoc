...
+
image:flexpod-genomics-image18.png["Uma captura de tela da guia GPUs do Inventário do Cisco UCS Manager mostrando uma placa gráfica P6 no modo Compute"]

+
image:flexpod-genomics-image19.png["Uma captura de tela do Cisco UCS Manager mostrando o inventário de GPUs com uma UCSB-GPU-P6-R no modo Compute"]
...
. Este comando instala o  https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere["Gerenciador de vGPU do NVIDIA"^] no ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["Uma captura de tela do vSphere Client mostrando o dispositivo gráfico NVIDIA Tesla P6 configurado para Shared Direct"]

+
image:flexpod-genomics-image21.png["Uma captura de tela da janela \"Editar configurações do dispositivo gráfico\" com a opção \"Compartilhado direto\" selecionada e a opção \"Reiniciar servidor X.Org\" marcada"]
...
+
image:flexpod-genomics-image22.png["Uma captura de tela das Opções de Inicialização da VM do vCenter mostrando o firmware EFI e a Inicialização Segura desativados"]
...
+
image:flexpod-genomics-image23.png["Uma captura de tela que mostra a seção Editar configurações avançadas do vCenter com um link Editar configuração"]

+
image:flexpod-genomics-image24.png["Uma captura de tela da caixa de diálogo Parâmetros de Configuração listando pciPassthru.64bitMMIOSizeGB e pciPassthru.use64bitMMIO valores"]
...
+
image:flexpod-genomics-image25.png["Uma captura de tela do vCenter Edit Settings mostrando o perfil vGPU NVIDIA GRID grid_p6-16c selecionado para um dispositivo PCI"]
...
+
image:flexpod-genomics-image26.png["Uma captura de tela da página de Clientes Licenciados do NVIDIA License Server, listando um cliente Ethernet virtual"]
