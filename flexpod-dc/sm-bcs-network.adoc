...
image:sm-bcs-image20.png["Um diagrama que mostra FI 6454, Nexus e AFF A250 com conectividade local redundante"]
...
image:sm-bcs-image21.png["Um diagrama que mostra os links entre pares vPC e os links entre sites dos switches FlexPod nos sites A e B"]
