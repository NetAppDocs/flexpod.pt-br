...
image:sm-bcs-image22.png["Um diagrama que mostra um AFF A250 conectado aos switches Nexus A e Nexus B em dois locais"]
...
image:sm-bcs-image23.png["Um diagrama que mostra as portas do controlador AFF A250 conectadas ao Nexus, grupos de interfaces, portas VLAN e LIFs"]
...
image:sm-bcs-image24.png["Um diagrama que mostra a conectividade redundante de boot SAN iSCSI dos servidores B200 M5 para os controladores AFF A250"]
...
image:sm-bcs-image25.png["Uma captura de tela da caixa de diálogo Adicionar Interfaces Intercluster do ONTAP System Manager com dois campos de endereço IP"]

Para analisar os dois clusters juntos, execute as seguintes etapas:

. Gere a senha de peering de cluster no primeiro cluster.
+
image:sm-bcs-image26.png["Uma captura de tela da caixa de diálogo Gerar Senha com permissões de peer de cluster, validade e uma senha copiada"]

. Invoque a opção Peer Cluster no segundo cluster e forneça as informações de senha e LIF entre clusters.
+
image:sm-bcs-image27.png["Uma captura de tela que mostra o System Manager cluster de pares com frase secreta e endereços LIF entre clusters"]
...
+
image:sm-bcs-image28.png["Uma captura de tela do System Manager do ONTAP Visão Geral de Proteção mostrando o peer de cluster e o status do mediador"]
...
image:sm-bcs-image29.png["Uma captura de tela da caixa de diálogo Configurar Mediador do ONTAP System Manager com os campos de conexão do mediador"]
...
image:sm-bcs-image30.png["Uma captura de tela do painel Visão geral da proteção do ONTAP System Manager mostrando o status do Mediador configurado"]
...
image:sm-bcs-image31.png["Uma captura de tela da caixa de diálogo Proteger grupo de consistência com o volume de origem esxi_a e o cluster de destino aff-a250-b"]
...
image:sm-bcs-image32.png["Uma captura de tela do System Manager do ONTAP mostrando dois grupos de consistência saudáveis e sincronizados no site A"]

Esta captura de tela mostra as relações de grupo de consistência no site B..

image:sm-bcs-image33.png["Uma captura de tela dos relacionamentos do System Manager do ONTAP no site B mostrando dois grupos de consistência saudáveis e sincronizados"]

Esta captura de tela mostra os detalhes da relação do grupo de consistência para o grupo cg_infra_datastore_B.

image:sm-bcs-image34.png["Uma captura de tela do ONTAP System Manager mostrando os detalhes do relacionamento do grupo de consistência cg_infra_datastore_b"]
...
image:sm-bcs-image35.png["Uma captura de tela das informações de volume do ONTAP para Infra-SVM-a, incluindo os volumes RW, DP e LS"]

Esta captura de tela mostra as informações de volume para o site B.

image:sm-bcs-image36.png["Uma captura de tela da saída do comando volume show do ONTAP para o Infra-SVM-b, listando nove volumes, incluindo volumes DP de destino"]
...
image:sm-bcs-image37.png["Uma captura de tela que mostra os igroups iSCSI do site A e os mapeamentos de LUN na saída da CLI do ONTAP"]

Esta captura de tela mostra os grupos de host e o mapeamento LUN para o cluster do site B.

image:sm-bcs-image38.png["Uma captura de tela da saída do comando de mapeamento de igroup e LUN do site B para hosts VMware iSCSI"]
