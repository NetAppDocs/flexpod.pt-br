...
image:sm-bcs-image16.png["Um diagrama que mostra os sites FlexPod A e B ligados por conexões estendidas de Camada 2 e relações SM-BC com o ONTAP Mediator no site C"]
