...
image:sm-bcs-image4.png["Um diagrama que mostra os sites FlexPod A e B conectados com até 10 ms de latência e um ONTAP Mediator no site C"]
...
image:sm-bcs-image5.png["Um diagrama que mostra os servidores Cisco UCS C240/C245, C220/C225, B200 e X210c M6"]
...
image:sm-bcs-image6.png["Um diagrama que mostra as vistas frontais dos módulos UCS 2408, 2304, 2208XP, 2204XP e UCSX 9108"]
...
image:sm-bcs-image7.png["Um diagrama que mostra os painéis frontais dos modelos Cisco UCS FI 6454, 64108, 6324, 6332 e 6332-16UP"]
...
image:sm-bcs-image8.png["Um diagrama que mostra as placas de ponte Cisco UCS VIC 1440, 1467, 1455, 1480, 1477, 1457, 14825, 14425 e 14000"]
...
image:sm-bcs-image9.png["Um diagrama que mostra os switches Cisco Nexus 9336C-FX2, 93180YC-FX3 e 3232C"]
...
image:sm-bcs-image10.png["Um diagrama que mostra as vistas frontais dos switches Cisco MDS 9132T, 9148T, 9148S, 9250i e 9396T"]
...
image:sm-bcs-image11.png["Um diagrama que mostra os controladores NetApp AFF e ASA e os gabinetes de discos DS 224C/2246 e NS 224"]
...
image:sm-bcs-image12.png["Um diagrama que mostra dois sites FlexPod com relações SM-BC e um ONTAP Mediator no Site C"]
...
image:sm-bcs-image13.png["Um diagrama que mostra sites FlexPod assimétricos conectados por links estendidos de Camada 2 e o ONTAP Mediator"]
...
image:sm-bcs-image14.png["Um diagrama que mostra sites FlexPod gerenciados pelo Intersight e pelo UCSM conectados por meio de uma malha VXLAN multi-site com relações SM-BC"]
...
image:sm-bcs-image15.png["Um diagrama que mostra FlexPod filiais conectadas a um datacenter por meio de uma malha VXLAN multi-site e o ONTAP Mediator"]
