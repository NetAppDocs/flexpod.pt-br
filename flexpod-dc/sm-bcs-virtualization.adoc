...
image:sm-bcs-image39.png["Um diagrama que mostra o VMware HA e o vSphere Metro Storage Cluster nos sites FlexPod A e B por meio de uma arquitetura multi-site"]
...
image:sm-bcs-image40.png["Um diagrama que mostra os servidores Cisco UCS B200 M5 e o armazenamento AFF A250 nos Sites A e B conectados por meio de switches Nexus e um ONTAP Mediator no Site C"]
...
image:sm-bcs-image41.png["Um diagrama que mostra os switches vSwitch0, vDS0, iSCSI-A e iSCSI-B com seis uplinks vNIC"]
...
image:sm-bcs-image42.png["Uma captura de tela que mostra os grupos de VMs/hosts para os hosts e VMs do Site A e do Site B em vSphere"]
...
image:sm-bcs-image43.png["Uma captura de tela da caixa de diálogo Editar Regra de VM/Host configurando as VMs do Site A para serem executadas em hosts do Site A"]

image:sm-bcs-image44.png["Uma captura de tela da caixa de diálogo Editar regra de VM/Host para VMs e hosts do Site B com a política de grupo \"Deve ser executada em hosts no grupo\" definida."]
...
image:sm-bcs-image45.png["Uma captura de tela das opções avançadas de HA do vSphere com quatro datastores de heartbeat e dois endereços de isolamento configurados"]
...
image:sm-bcs-image46.png["Uma captura de tela das configurações de HA Heartbeat Datastores do vSphere com quatro datastores especificados selecionados"]

Para obter práticas recomendadas e configurações adicionais para o VMware HA Cluster e o VMware vSphere Metro storage cluster, consulte  https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.avail.doc/GUID-5432CA24-14F1-44E3-87FB-61D937831CF6.html["Criação e uso de clusters de HA do vSphere"^],  https://core.vmware.com/resource/vmware-vsphere-metro-storage-cluster-vmsc["VMware vSphere Metro Storage Cluster (vMSC)"^] e  https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html["NetApp ONTAP com SnapMirror active sync (anteriormente SM-BC) e VMware vSphere Metro Storage Cluster (vMSC)"^].
