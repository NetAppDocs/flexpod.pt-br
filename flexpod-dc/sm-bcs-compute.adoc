...
image:sm-bcs-image17.png["Um diagrama que mostra UCS 2204XP A e B conectados a um B200 M5 VIC via 10GBASE-KR"]
...
image:sm-bcs-image18.png["Um diagrama que mostra os módulos IOM UCS 5108 conectados aos switches FI 6454 e aos switches Nexus A e B"]
...
image:sm-bcs-image19.png["Uma captura de tela que mostra a caixa de diálogo \"Definir parâmetros de inicialização iSCSI\" do Cisco UCS Manager com dois destinos estáticos configurados"]
