...
image:sm-bcs-image47.png["Um diagrama que mostra os caminhos iSCSI do ESXi através de duas fabrics para os LUNs do grupo de consistência primário e de destino"]
...
image:sm-bcs-image48.png["Uma captura de tela da guia Caminhos dos Adaptadores de Armazenamento do ESXi mostrando dois caminhos ativos (E/S) e seis caminhos iSCSI ativos"]
...
[[vmware-vmotion-and-vmhost-affinity-test]]
...
image:sm-bcs-image49.png["Uma captura de tela do vSphere Client mostrando seis datastores iSCSI montados no host esxi-a-01.nva.local"]
...
image:sm-bcs-image50.png["Uma captura de tela da seleção de armazenamento de migração no vSphere para o iometer-a-01 com datastores iSCSI dos sites A e B"]
...
+
image:sm-bcs-image51.png["Uma captura de tela do ONTAP System Manager Relationships com o menu de opções de origem mostrando o Failover"]

. Confirme o failover para que a ação seja iniciada.
+
image:sm-bcs-image52.png["Uma captura de tela do ONTAP System Manager com a confirmação de failover planejado para cg_esxi_a de Infra-SVM.1 para Infra-SVM-b"]
...
image:sm-bcs-image53.png["Uma captura de tela do ONTAP System Manager mostrando os gráficos de desempenho do site A com IOPS e taxa de transferência reduzidos"]
...
image:sm-bcs-image54.png["Uma captura de tela do painel do ONTAP System Manager mostrando o desempenho em 132,99 mil IOPS e 1.038,58 MB/s de taxa de transferência"]
...
image:sm-bcs-image55.png["Uma captura de tela do ONTAP System Manager Relationships mostrando grupos de consistência íntegros e sincronizados e uma opção de menu de Failover."]
...
image:sm-bcs-image56.png["Um diagrama que mostra o armazenamento do Site A indisponível e os serviços de dados SM-BC continuando no Site B por meio do ONTAP Mediator"]
...
image:sm-bcs-image57.png["Uma captura de tela do painel do ONTAP System Manager mostrando 80,32 mil IOPS e 626,98 MB/s de taxa de transferência"]

image:sm-bcs-image58.png["Uma captura de tela do painel do ONTAP System Manager para aff-a250-b mostrando 81,37 mil IOPS e 635,41 MB/s de taxa de transferência"]
...
image:sm-bcs-image59.png["Uma captura de tela do ONTAP System Manager mostrando um aumento acentuado no desempenho de IOPS e throughput no cluster aff-a250-b"]
...
image:sm-bcs-image60.png["Uma captura de tela do ONTAP System Manager mostrando dois relacionamentos saudáveis fora de sincronia"]
...
image:sm-bcs-image61.png["Uma captura de tela que mostra os relacionamentos do ONTAP System Manager com status saudável e em estado sincronizado"]
...
image:sm-bcs-image62.png["Uma captura de tela da caixa de diálogo Editar Regra de VM/Host atribuindo VMs do Site A ao grupo de hosts do Site B"]
...
image:sm-bcs-image63.png["Uma captura de tela de duas janelas da CLI do BMC mostrando os comandos de desligamento do sistema para aff-a250-a-01 e aff-a250-a-02"]
...
image:sm-bcs-image64.png["Uma captura de tela de um painel do Grafana mostrando as métricas de latência, throughput e IOPS da SVM para o Infra-SVM no cluster AFF A250."]

image:sm-bcs-image65.png["Uma captura de tela do painel do Grafana SVM mostrando os gráficos de latência, taxa de transferência e IOPS para o Infra-SVM-b"]
...
image:sm-bcs-image66.png["Uma captura de tela das opções de compilação do TPROC-C do Microsoft SQL Server com 100 warehouses e 10 usuários virtuais"]
...
image:sm-bcs-image67.png["Uma captura de tela do contador de transações do HammerDB mostrando uma breve queda e recuperação de transações durante a criação do TPROC-C"]
...
image:sm-bcs-image68.png["Uma captura de tela do painel do Grafana da NAbox mostrando a latência do cluster de armazenamento do site B, a taxa de transferência e as métricas de IOPS caindo para zero"]
...
image:sm-bcs-image69.png["Uma captura de tela do painel do Grafana da NAbox mostrando as métricas de latência, throughput e IOPS da SVM do site A"]
