...
image:sm-bcs-image2.png["Um diagrama que mostra os componentes do FlexPod Datacenter: Cisco UCS, switches Nexus/MDS e o armazenamento NetApp AFF/FAS/ASA"]
...
image:sm-bcs-image3.png["Um diagrama que mostra a replicação síncrona do SnapMirror e o failover automatizado entre os datacenters primário e secundário"]
