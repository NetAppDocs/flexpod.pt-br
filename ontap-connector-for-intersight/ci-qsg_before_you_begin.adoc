...
. Faça o download do Cisco Intersight Virtual Appliance em https://software.cisco.com/download/home/286319499/type/286323047/release/1.1.7-0.a["software.Cisco.com"^]. Para obter mais informações, acesse o https://www.cisco.com/c/en/us/td/docs/unified_computing/Intersight/b_Cisco_Intersight_Appliance_Getting_Started_Guide/b_Cisco_Intersight_Appliance_Install_and_Upgrade_Guide_chapter_00.html["Guia de instalação e atualização do Intersight Appliance"^].
...
+
.. Navegue até  `https://<FQDN-of-your-appliance>` para concluir a configuração pós-instalação do seu appliance.
+
