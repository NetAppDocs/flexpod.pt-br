...
NOTE: Consulte  https://intersight.com/help/saas/supported_systems/overview["Sistemas compatíveis com Cisco Intersight"^]os requisitos mínimos dos componentes de computação do Cisco UCS e a versão do UCSM.
...
Para obter mais informações sobre os recursos abrangidos pelos vários níveis de licenciamento, acesse  https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Licença dos Serviços de infraestrutura"^].
