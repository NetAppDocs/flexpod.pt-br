...
Para obter mais informações sobre os gabinetes de discos e mídias de armazenamento, consulte o link "Especificações técnicas dos gabinetes de discos e mídias de armazenamento" na tabela a seguir.

|===
| Compartimento de disco | Especificações técnicas 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["Especificações técnicas de prateleiras para discos e mídias de armazenamento"] 
