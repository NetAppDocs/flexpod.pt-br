...
A figura a seguir ilustra o FlexPod Datacenter para FC com Cisco MDS.
...
Para obter mais informações sobre a implementação do ONTAP, consulte  https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684: Implementando e configurando SANs modernas com NVMe"^].
