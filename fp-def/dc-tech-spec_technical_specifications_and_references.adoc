...
| NetApp AFF A800 | https://docs.netapp.com/us-en/ontap-systems/a800/install-setup.html["Documentação da Plataforma AFF A800"] 


| NetApp AFF A700 | https://docs.netapp.com/us-en/ontap-systems/a700/install-setup.html["Documentação da Plataforma AFF A700"] 


| NetApp AFF A700s | https://docs.netapp.com/us-en/ontap-systems/a700s/install-setup.html["Documentação da Plataforma AFF A700s"] 


| NetApp AFF A400 | https://docs.netapp.com/us-en/ontap-systems/a400/install-setup.html["Documentação da Plataforma AFF A400"] 


| NetApp AFF A250 | https://docs.netapp.com/us-en/ontap-systems/a250/install-setup.html["Documentação da Plataforma AFF A250"] 
|===
...
As especificações técnicas para os NetApp disk shelves incluem o fator forma, o número de unidades por gabinete e os módulos de E/S do gabinete; esta documentação pode ser encontrada na tabela a seguir. Para mais informações, consulte a https://www.netapp.com/data-storage/disk-shelves-storage-media/["Especificações técnicas dos compartimentos de disco e Mídia de storage da NetApp"^] e a https://hwu.netapp.com/["NetApp Hardware Universe"^].
