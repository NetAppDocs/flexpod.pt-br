...
Os requisitos de software para o FlexPod Express com E-Series incluem:

* Software SANtricity E-Series 11.30 ou superior
* Cisco UCS Manager 4.0(1b).


Todo o software deve estar listado e ser suportado no  http://support.netapp.com/matrix/["NetApp IMT"^].
