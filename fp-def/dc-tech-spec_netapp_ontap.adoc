...
[role="lead"]
NetApp ONTAP software está instalado em todos os sistemas NetApp FAS, AFF e ASA. FlexPod é validado com o software ONTAP, proporcionando uma arquitetura de storage dimensionável que permite operações sem interrupções, atualizações sem interrupções e uma infraestrutura de dados ágil.
