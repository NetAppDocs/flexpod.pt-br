...
* *FlexPod Datacenter.* Esta plataforma é uma infraestrutura de data center altamente dimensionável, adequada para cargas de trabalho e aplicativos empresariais, virtualização, VDI e nuvem pública e privada. O FlexPod Datacenter tem suas próprias especificações, que estão documentadas em https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["Especificações técnicas do data center FlexPod"^].
